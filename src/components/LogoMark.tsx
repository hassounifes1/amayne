...
export default function LogoMark({ tagline, taglineSmall, variant = 'dark', className = '' }: LogoMarkProps) {
  const tagSize = taglineSmall ? 4.2 : 4.8;
  const tagY = taglineSmall ? 93.5 : 92.8;
  ...
  return (
    <svg
      ...
      className={className}
      role="img"
      aria-label={`AMAYNO — ${tagline}`}
    >
      <defs>
        <linearGradient id="amayno-blue" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <linearGradient id="green-shine" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <filter id="text-shadow" x="-10%" y="-10%" width="120%" height="130%">
      ...
      <g filter="url(#soft-shadow)">
        ...
        {/* Gold leaf */}
        <path
          d="M52 11 C58 6 66 8 68 14 C64 16 56 15 52 11Z"
          fill="url(#gold-shine)"
        />
        {/* Honey drip top */}
        ...
        {/* Honey dipper top-right */}
        <circle cx="98" cy="36" r="3.2" fill="url(#gold-shine)" />
        <rect x="96.8" y="36" width="2.4" height="9" rx="1" fill="url(#gold-shine)" />
      </g>
      ...
      <g filter="url(#soft-shadow)">
        <path
          ...
          stroke="url(#green-shine)"
          strokeWidth="5.5"
          strokeLinecap="round"
          fill="none"
        />
        {/* Green leaves */}
        <path d="M34 78 C28 74 26 68 30 64 C36 66 38 72 34 78Z" fill="url(#green-shine)" />
        <path d="M86 78 C92 74 94 68 90 64 C84 66 82 72 86 78Z" fill="url(#green-shine)" />
        {/* Almonds bottom */}
        ...
        {/* Honey dipper bottom-left */}
        <circle cx="22" cy="64" r="3.2" fill="url(#green-shine)" />
        <rect x="20.8" y="55" width="2.4" height="9" rx="1" fill="url(#green-shine)" />
      </g>
      ...
      {tagline ? (
        <text
          ...
          fontSize={tagSize}
          fontWeight="600"
          letterSpacing={taglineSmall ? 0.4 : 0.8}
        >
          {tagline.length > 24 ? `${tagline.slice(0, 24)}…` : tagline}
        </text>
      ) : null}
    </svg>
  );
