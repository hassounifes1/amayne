    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="grid grid-cols-[auto_1fr_auto] lg:flex lg:items-center lg:justify-between h-16 sm:h-[4.25rem] md:h-20 gap-2 sm:gap-4">
            {/* Mobile menu */}
            <button
            ...
            <Link href="/" className="flex items-center justify-center lg:justify-start shrink-0" onClick={() => setMobileMenuOpen(false)}>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden fixed inset-0 top-[calc(2.5rem+4rem)] sm:top-[calc(2.5rem+4.25rem)] md:top-[calc(2.5rem+5rem)] z-40 bg-brand-cream/98 backdrop-blur-md border-t border-brand-border overflow-y-auto pb-safe">
