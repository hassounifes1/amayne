...
const footerLinks = {
  shop: [
    { href: '/collections/robes', label: 'Robes Élégantes' },
    { href: '/collections/ensembles', label: 'Ensembles & Sets' },
    { href: '/collections/hauts', label: 'Hauts & Tuniques' },
    { href: '/collections/pantalons', label: 'Pantalons & Jupes' },
    { href: '/collections/manteaux', label: 'Manteaux & Vestes' },
  ],
  help: [
    ...
    <footer className="bg-brand-plum text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs text-white/60">Pas de risque</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-2xl mb-1">🔄</span>
              <span className="text-sm font-medium">Retour Gratuit</span>
              <span className="text-xs text-white/60">Sous 30 jours</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-2xl mb-1">💬</span>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <span className="font-display text-2xl font-bold tracking-wider">AMAYNE</span>
            <p className="mt-3 text-sm text-white/70 leading-relaxed">
              La mode qui te mérite. Conçue au Maroc pour les femmes qui refusent de compromettre entre style et confort.
            </p>
            <div className="flex space-x-4 mt-4">
              <a href="https://instagram.com/amayne.official" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center text-sm text-white/60">
          <p>© 2026 AMAYNE. Tous droits réservés.</p>
          <p className="mt-2 md:mt-0">Made with ❤️ in Morocco 🇲🇦</p>
        </div>
      </div>
    </footer>
  );
